...
long long int Fibonacci(long long int n){
    if(n==0) return 0LL;
    if(n<=2) return 1LL;
    vector<vector<long long int>> base = {{1LL,1LL},{1LL,0LL}};
    base = ModularMatrixExponentiation(base,n-2,INT32_MAX);
...
// int main(){ // to debug
//     for(long long int i= 0; i<1000;i++)cout<<i<<" "<<Fibonacci(i)<<endl;
// }